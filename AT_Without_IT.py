...
run_data = run_simulation(seed=target_seed, beta=0)

print("Simulation complete.")

print("\nFormatting micro-data for CSV export...")
micro_csv_rows = []
...
micro_save_path = os.path.join(script_dir, f"ablation_no_IT_micro_seed_{target_seed}.csv")
...
fig.suptitle(f"Ablation: Identity Theory DISABLED | Micro Trajectories (Seed: {target_seed})", fontsize=18, fontweight='bold')
