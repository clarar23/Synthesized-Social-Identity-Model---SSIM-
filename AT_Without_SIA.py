...
run_data = run_simulation(seed=target_seed, use_SIA=False)
...
micro_save_path = os.path.join(script_dir, f"ablation_no_SIA_micro_seed_{target_seed}.csv")
...
fig.suptitle(f"Ablation: Social Identity DISABLED | Micro Trajectories (Seed: {target_seed})", fontsize=18, fontweight='bold')
