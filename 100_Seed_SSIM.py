...
# =====================================================================
# --- EXECUTION BLOCK: BASELINE SIMULATION (100 SEEDS) ---
# =====================================================================
print(f"Starting Baseline Simulation ({num_seeds} seeds)...")

# We will store the full time-series arrays for every seed here
all_op_A, all_op_B = [], []
all_id_A, all_id_B = [], []
all_se_A, all_se_B = [], []
...
for i in range(num_seeds):
    ...
    # Run the model with default parameters (no sweep)
    run_data = run_simulation(seed=random_seed) 
    
    # Extract the full array of values across all time steps for this seed
...
# Convert lists to 2D numpy arrays (rows = seeds, columns = time steps)
...
# Reconstruct the time steps array based on the length of the data
num_recorded_points = mat_op_A.shape[1]
time_steps = np.linspace(0, num_steps, num_recorded_points)

# Create a DataFrame with the Means and SDs calculated vertically across the 100 seeds (axis=0)
...
# =====================================================================
# --- PLOTTING: 1x3 TIME-SERIES GRID (100 SEEDS) ---
# =====================================================================
